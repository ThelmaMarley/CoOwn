...
if (loading) {
return <div className="p-20 text-center">Loading Property...</div>;
}
...
const soldShares = property.total_shares - property.shares_remaining;

const fundedPercent =
property.total_shares > 0
? Math.round((soldShares / property.total_shares) * 100)
: 0;
...
onChange={(e) =>
setShares(
Math.min(Number(e.target.value), property.shares_remaining)
)
}
